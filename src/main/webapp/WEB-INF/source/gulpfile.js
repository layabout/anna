            ...
            patterns: [
                ...
                },
                {
                    ...
                    replacement: function() {
                        ...
                        assetsKeys.forEach(function(identity) {
                            if (identity == htmlFileName) {
                                if (WebpackAssets['lib'].css != undefined) {
                                    styles += '\n    <link rel="stylesheet" type="text/css" href="'+ WebpackAssets['lib'].css +'" />';
                                }

                                if (WebpackAssets['vendors'].css != undefined) {
                                    styles += '\n    <link rel="stylesheet" type="text/css" href="'+ WebpackAssets['vendors'].css +'" />';
                                }

                                if (WebpackAssets[htmlFileName].css != undefined) {
